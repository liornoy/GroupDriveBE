errors = {
    ...
    "TripNotExistsError": {
        "message": "Trip with given id doesn't exists",
        "status": 400,
    },
    "UserAlreadyExistsError": {"message": "User already exists", "status": 400},
    "UnauthorizedError": {"message": "user is forbidden", "status": 403},
    "UserNotExistsError": {
